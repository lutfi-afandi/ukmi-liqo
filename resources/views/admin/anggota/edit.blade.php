                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama"
                                    ...
                                    placeholder="Masukan nama" autofocus autocomplete="false"
                                    value="{{ old('nama', $anggota->nama) }}"> {{-- Nilai awal dari $anggota --}}
                                @error('nama')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="npm" class="form-control @error('npm') is-invalid @enderror"
                                    id="npm" placeholder="Masukan npm" value="{{ old('npm', $anggota->npm) }}"
                                    readonly>
                                {{-- Nilai awal dari $anggota --}}
                                @error('npm')
                                    <span class="error invalid-feedback"> {{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-10">
                                <select name="tahun_masuk" class="form-control @error('tahun_masuk') is-invalid @enderror"
                                    ...
                                    @for ($tahun = date('Y'); $tahun >= 2015; $tahun--)
                                        <option value="{{ $tahun }}"
                                            {{ old('tahun_masuk', $anggota->tahun_masuk) == $tahun ? 'selected' : '' }}>
                                            {{ $tahun }}
                                        </option>
                                    @endfor
                                </select>
                                ...
                                <select name="jurusan_id"
                                    ...
                                    @foreach ($jurusans as $jurusan)
                                        <option value="{{ $jurusan->id }}"
                                            {{ old('jurusan_id', $anggota->jurusan_id) == $jurusan->id ? 'selected' : '' }}>
                                            {{ $jurusan->nama }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="no_telepon"
                                    ...
                                    value="{{ old('no_telepon', $anggota->no_telepon) }}"> {{-- Nilai awal dari $anggota --}}
                                @error('no_telepon')
                                    <span class="error invalid-feedback"> {{ $message }}</span>
                                @enderror
                            </div>
