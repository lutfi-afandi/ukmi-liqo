    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card card-primary ">
                ...
                <div class="card-body">
                    <iframe src="{{ asset('storage/uploads/file_tw4/' . $triwulan4->file_tw4) }}" width="100%"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border"
                            value="{{ date('d/m/Y H:i', strtotime($triwulan4->tgl_upload)) }}" readonly>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Diterima Berkas : </label>
                        <input type="text" class="form-control form-control-border"
                            value="{{ $triwulan4->tgl_konf != null ? date('d/m/Y H:i', strtotime($triwulan4->tgl_konf)) : '' }}"
                            readonly>
                    </div>
                    <div class="form-group">
                        <label>Status : </label>
                        <input type="text" class="form-control form-control-border" value="{{ $triwulan4->konf }}"
                            readonly>
                    </div>
                    <form action="{{ route('admin.triwulan4.update', ['triwulan4' => $triwulan4->id]) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group">
...
@section('js')
    ...
    <script>
        function lihat(parameter_file) {
            ...
            var storage = "{{ asset('storage/uploads/file_tw4/') }}/";
