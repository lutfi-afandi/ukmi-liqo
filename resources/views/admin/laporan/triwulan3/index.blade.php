    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card card-primary ">
                ...
                <div class="card-body">
                    <iframe src="{{ asset('storage/uploads/file_tw3/' . $triwulan3->file_tw3) }}" width="100%"
                        height="840px" frameborder="0"></iframe>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border"
                            value="{{ date('d/m/Y H:i', strtotime($triwulan3->tgl_upload)) }}" readonly>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Diterima Berkas : </label>
                        <input type="text" class="form-control form-control-border"
                            value="{{ $triwulan3->tgl_konf != null ? date('d/m/Y H:i', strtotime($triwulan3->tgl_konf)) : '' }}"
                            readonly>
                    </div>
                    <div class="form-group">
                        <label>Status : </label>
                        <input type="text" class="form-control form-control-border" value="{{ $triwulan3->konf }}"
                            readonly>
                    </div>
                    <form action="{{ route('admin.triwulan3.update', ['triwulan3' => $triwulan3->id]) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group">
