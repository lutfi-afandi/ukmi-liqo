                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border"
                            value="{{ date('d/m/Y H:i', strtotime($sarmut->tgl_upload_sarmut)) }}" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Status : </label>
                        <input type="text" class="form-control form-control-border" value="{{ $sarmut->konf_sarmut }}"
                            readonly>
                    </div>
                    <form action="{{ route('admin.sarmut.update', ['sarmut' => $sarmut->id]) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label>Set Status:</label>
                            <select class="form-control" name="konf_sarmut" required>
                                <option value="" hidden>-Pilih Status-</option>
                                <option value="sedang" {{ $sarmut->konf_sarmut == 'sedang' ? 'selected' : '' }}>diperiksa
                                </option>
                                <option {{ $sarmut->konf_sarmut == 'diterima' ? 'selected' : '' }}>diterima</option>
                                <option {{ $sarmut->konf_sarmut == 'ditolak' ? 'selected' : '' }}>ditolak</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Catatan Aditor:</label>
                            <textarea id="summernote" name="ket_sarmut" placeholder="catatan Auditor">
                                {!! $sarmut->ket_sarmut ?? '' !!}
                            </textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <button class="btn bg-navy d-flex"><i class="fas fa-history"></i>
                        Riwayat</button>
                </div>
